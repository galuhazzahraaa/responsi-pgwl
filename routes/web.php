...
Route::get('/', function () {
    return view('landing')->with('title', 'Landing Page');
})->name('index');

Route::get('/index-public', function () {
    return view('index-public')->with('title', 'Map Application');
})->name('index-public');

Route::get('/index', function () {
    return view('index')->with('title', 'Map Application');
})->name('index');
...
use App\Http\Controllers\YourController; // Pastikan untuk menyesuaikan nama controller
